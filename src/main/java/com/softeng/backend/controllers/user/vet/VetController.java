...
public class VetController implements IVetController {
    ...
    public ResponseEntity<Map<String, Object>> createVet(@Valid @RequestBody Vet vet) {
        ...
        if (vet == null || vet.checkInvalidUser()) {
            ...
            log.debug("DEBUG LOG: Vet /create endpoint detected null request");
        ...
        try {
            ...
            if (dto == null || dto.isEmpty()) {
                log.debug("DEBUG LOG: Vet with email: {} already exists", vet.getEmail());
            ...
            log.debug("DEBUG LOG: Vet /create endpoint not found for vet: {}\n stack trace: {}", vet.getEmail(), Arrays.toString(e.getStackTrace()));
    ...
    public ResponseEntity<Map<String, Object>> getVetById(@PathVariable String id) {
        ...
        try {
            ...
            log.debug("DEBUG LOG: Vet /id endpoint failed: {}", Arrays.toString(e.getStackTrace()));
            return ResponseEntity.internalServerError().build();
        }

        if (dto == null || dto.isEmpty()) {
            log.debug("DEBUG LOG: Vet /id endpoint hit with id: {} not found", id);
    ...
    public ResponseEntity<Map<String, Object>> updateVet(@PathVariable String id, @Valid @RequestBody Vet vet) {
        ...
        if (vet == null || vet.checkEmptyUser()) {
            log.debug("DEBUG LOG: Vet update /id endpoint detected empty request: {}", id);
        ...
        try {
            ...
            log.debug("DEBUG LOG: Vet /update endpoint failed: {}", Arrays.toString(e.getStackTrace()));
            return ResponseEntity.internalServerError().build();
        }

        if (dto == null || dto.isEmpty()) {
            log.debug("DEBUG LOG: Vet update /id endpoint not found for id: {}", id);
            return ResponseEntity.notFound().build();
        }
        return ResponseEntity.ok().body(dto.toMap());
    }
    ...
    public ResponseEntity<Map<String, Object>> deleteVet(@PathVariable String id) {
        ...
        if (dto == null || dto.isEmpty()) {
            log.debug("DEBUG LOG: Vet delete /id endpoint not found for id: {}", id);
            return ResponseEntity.notFound().build();
        }
        ...
        try {
            ...
            log.debug("DEBUG LOG: delete /id endpoint failed for id: {}", id);
            return ResponseEntity.internalServerError().build();
        }
